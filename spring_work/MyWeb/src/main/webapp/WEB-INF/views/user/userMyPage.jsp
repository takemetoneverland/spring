...
<script>
	...
	$(function() { //document.readyfunction 제이쿼리 시작
	//비밀번호가 올바른 정규표현식대로 작성이 되었는지를 검증해서
	//만약 정규표현식에 맞지 않는 값이라면 alert()으로 검증하기.
	//나머지 입력창 빈칸 여부를 확인해서 모두 작성이 잘 되었다면 submit() 처리하기.
	const regex = /^[A-Za-z0-9+]{8,16}$/;
	//const pwCheck = RegExp(/^[A-Za-z0-9+]{8,16}$/); 위에꺼랑 같은 거임.
